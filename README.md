Все задания выполнены студентом Бакулевым А. М. M3*41 ИСУ - 501533 (tg - @LortyMorty)

Репозиторий сделан с целью ознакомления с программой первого семестра Основы программирования бакалавриата AI360/Компьютерные технологии ИТМО

Любое копирование и использования кода из этого репозитория для сдачи своего дз запрещено (иначе вас поймают на списывании)
